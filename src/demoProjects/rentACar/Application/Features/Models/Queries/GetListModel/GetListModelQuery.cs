...
{
    public class GetListModelQuery:IRequest<ModelListModelByDynamic>
    {
        public PageRequest PageRequest { get; set; }

        public class GetListModelQueryHandler : IRequestHandler<GetListModelQuery, ModelListModelByDynamic>
        {
            ...
            public async Task<ModelListModelByDynamic> Handle(GetListModelQuery request, CancellationToken cancellationToken)
            {
